...
var $author$project$UI$Sidebar$SelectIndex = {$: 'SelectIndex'};
...
var $author$project$UI$Elements$dropDownButton = F2(
	function (t, msg) {
		return A2(
...
var $author$project$UI$Elements$dropDownBody = F2(
	function (l, msg) {
		return A2(
			...
			A2(
				$elm$core$List$map,
				function (x) {
					return A2($author$project$UI$Elements$dropDownButton, x, msg);
				},
				l));
	});
...
var $author$project$UI$Elements$dropDown = F4(
	function (v, l, clickDropdownButton, selectItem) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					A2($author$project$UI$Elements$dropDownButton, v, clickDropdownButton),
					A2($author$project$UI$Elements$dropDownBody, l, selectItem)
				]));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A4(
					$author$project$UI$Elements$dropDown,
					'Suggestions',
					_List_fromArray(
						['Index 1', 'Index 2', 'Index 3']),
					$author$project$UI$Sidebar$ShowIndices,
					$author$project$UI$Sidebar$SelectIndex)),
				$mdgriffith$elm_ui$Element$scrollbarY
			]),
		_List_fromArray(
			[
