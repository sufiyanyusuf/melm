...
var $author$project$UI$Components$SynonymCard$NoRequest = {$: 'NoRequest'};
var $author$project$UI$Components$SynonymCard$init = F2(
	function (index, indexUid) {
		return {index: index, indexId: indexUid, requestStatus: $author$project$UI$Components$SynonymCard$NoRequest, saved: $elm$core$Maybe$Nothing, synonymKey: '', synonymList: _List_Nil, synonymsValue: '', taskId: $elm$core$Maybe$Nothing};
	});
...
var $author$project$Main$UpdateKeysForIndex = function (a) {
	return {$: 'UpdateKeysForIndex', a: a};
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $author$project$Main$receivedKeysFromJs = _Platform_incomingPort(
	'receivedKeysFromJs',
	A2(
...
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Main$receivedKeysFromJs($author$project$Main$UpdateKeysForIndex)
			]));
};
			...
			F2(
				function (index, _v0) {
					...
					return {
						index: index,
						indexId: indexId,
						requestStatus: $author$project$UI$Components$SynonymCard$NoRequest,
...
var $author$project$Main$getKeysFromJS = _Platform_outgoingPort(
	'getKeysFromJS',
	$elm$json$Json$Encode$list($elm$json$Json$Encode$string));
...
var $author$project$Api$Routes$Main$HandleDocumentAttrsResponse = F2(
	function (a, b) {
		return {$: 'HandleDocumentAttrsResponse', a: a, b: b};
	});
...
var $author$project$Main$handleApiRequest = F2(
	function (model, apiResponse) {
		switch (apiResponse.$) {
			...
			case 'HandleDocumentAttrsResponse':
				var r = apiResponse.a;
				var indexUid = apiResponse.b;
				if (r.$ === 'Ok') {
					var payload = r.a;
					return _Utils_Tuple2(
						model,
						$author$project$Main$getKeysFromJS(
							_List_fromArray(
								[payload, indexUid])));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
