		...
		switch (pageViewMsg.$) {
			...
			case 'TasksViewMsg':
				return _Debug_todo(
					'Main',
					{
						start: {line: 484, column: 13},
						end: {line: 484, column: 23}
		...
		switch (p.$) {
			...
			case 'RankingRules':
				return _Debug_todo(
					'Main',
					{
						start: {line: 865, column: 21},
						end: {line: 865, column: 31}
