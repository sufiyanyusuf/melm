		...
		switch (r.$) {
			...
			case 'ResetStopWords':
				return _Debug_todo(
					'Api.Routes.Main',
					{
						start: {line: 171, column: 13},
						end: {line: 171, column: 23}
					})('branch \'ResetStopWords\' not implemented');
			case 'GetTask':
				return _Debug_todo(
					'Api.Routes.Main',
					{
						start: {line: 174, column: 13},
						end: {line: 174, column: 23}
...
var $author$project$UI$PageViews$Attributes$seedModelFromAttributeKeys = function (l) {
	return {
		displayed: A2(
			$elm$core$List$map,
			function (x) {
...
var $author$project$UI$PageViews$Attributes$init = $author$project$UI$PageViews$Attributes$seedModelFromAttributeKeys(_List_Nil);
...
var $author$project$UI$PageViews$Synonyms$init = {deletionQueue: _List_Nil, synonymCards: _List_Nil};
...
var $author$project$Main$init = function (_v0) {
	var model = {pages: $author$project$UI$Pages$init, pollingQueue: _List_Nil, sidebarModel: $author$project$UI$Sidebar$init};
	return _Utils_Tuple2(
		model,
		A2(
			$elm$core$Platform$Cmd$map,
...
var $author$project$UI$PageViews$Attributes$HandleResponse = F2(
	function (a, b) {
		return {$: 'HandleResponse', a: a, b: b};
	});
...
var $author$project$UI$PageViews$Attributes$UpdateSyncStatusState = F2(
	function (a, b) {
		return {$: 'UpdateSyncStatusState', a: a, b: b};
	});
var $author$project$UI$PageViews$Attributes$UpdateAttributes = F2(
	function (a, b) {
		return {$: 'UpdateAttributes', a: a, b: b};
	});
...
var $author$project$UI$PageViews$Attributes$getAttrs = F2(
...
var $author$project$UI$PageViews$Attributes$updateAttributes = F3(
	function (model, attrs, attrType) {
		switch (attrType.$) {
			case 'Displayed':
				return _Utils_update(
					model,
...
var $author$project$UI$PageViews$Attributes$update = F2(
	function (msg, model) {
		update:
		while (true) {
			switch (msg.$) {
				case 'UpdateAttributes':
					var l = msg.a;
					var t = msg.b;
					return A3($author$project$UI$PageViews$Attributes$updateAttributes, model, l, t);
				case 'HandleResponse':
					var t = msg.a;
					var l = msg.b;
					return A3($author$project$UI$PageViews$Attributes$buildModelFromResponse, t, l, model);
				case 'UpdateSyncStatusState':
					var t = msg.a;
					var r = msg.b;
					var l = A2($author$project$UI$PageViews$Attributes$getAttrs, model, t);
					var ul = A2($author$project$UI$PageViews$Attributes$updateSyncStatusState, l, r);
					var $temp$msg = A2($author$project$UI$PageViews$Attributes$UpdateAttributes, ul, t),
						$temp$model = model;
					msg = $temp$msg;
					model = $temp$model;
					continue update;
				case 'Toggle':
					...
					var ul = A2(
						$elm$core$List$map,
						function (x) {
							return _Utils_eq(x.title, a.title) ? _Utils_update(
								x,
								{enabled: !x.enabled}) : x;
						},
						A2($author$project$UI$PageViews$Attributes$getAttrs, model, t));
					var $temp$msg = A2($author$project$UI$PageViews$Attributes$UpdateAttributes, ul, t),
						$temp$model = model;
					msg = $temp$msg;
					model = $temp$model;
					continue update;
				case 'Purge':
					return $author$project$UI$PageViews$Attributes$init;
				default:
					return model;
			}
		}
		...
		return A2(
			...
			function (c) {
				var savedValue = function () {
					if (status.$ === 'Success') {
						return $elm$core$Maybe$Just(
							_Utils_Tuple2(c.synonymKey, c.synonymList));
					} else {
						return c.saved;
					}
				}();
				return $author$project$UI$Components$SynonymCard$valueChanged(c) ? _Utils_update(
					c,
					{requestStatus: status, saved: savedValue}) : c;
			},
			model);
	});
			...
			if (newData.$ === 'Just') {
				...
				switch (d) {
					...
					case 'processing':
						switch (task.$) {
							case 'UpdateSynonymsTask':
								var updatedSynonyms = A2($author$project$UI$PageViews$Synonyms$updateSyncStatusState, model.pages.synonyms.synonymCards, $author$project$Request$Fired);
								var updatedSynonymsPageViewModel = {deletionQueue: model.pages.synonyms.deletionQueue, synonymCards: updatedSynonyms};
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
					...
					case 'succeeded':
						switch (task.$) {
							case 'UpdateSynonymsTask':
								var updatedSynonyms = A2($author$project$UI$PageViews$Synonyms$updateSyncStatusState, model.pages.synonyms.synonymCards, $author$project$Request$Success);
								var updatedSynonymsPageViewModel = {deletionQueue: _List_Nil, synonymCards: updatedSynonyms};
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
							...
							default:
								var attrType = task.c;
								var attrsPageViewModel = A2(
									$author$project$UI$PageViews$Attributes$update,
									A2($author$project$UI$PageViews$Attributes$UpdateSyncStatusState, attrType, $author$project$Request$Success),
									model.pages.attributes);
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
											pages: A2($author$project$Main$updateAttributesViewModel, model.pages, attrsPageViewModel),
											pollingQueue: A2(
												$elm$core$List$filter,
												function (_v7) {
													var x = _v7.a;
					...
					case 'failed':
						switch (task.$) {
							case 'UpdateSynonymsTask':
								var updatedSynonyms = A2($author$project$UI$PageViews$Synonyms$updateSyncStatusState, model.pages.synonyms.synonymCards, $author$project$Request$Failed);
								var updatedSynonymsPageViewModel = {deletionQueue: model.pages.synonyms.deletionQueue, synonymCards: updatedSynonyms};
								return _Utils_Tuple2(
									_Utils_update(
										model,
							...
							case 'UpdateAttributeTask':
								...
								var attrsPageViewModel = A2(
									$author$project$UI$PageViews$Attributes$update,
									A2($author$project$UI$PageViews$Attributes$UpdateSyncStatusState, t, $author$project$Request$Failed),
									model.pages.attributes);
								return _Utils_Tuple2(
									_Utils_update(
										model,
...
var $author$project$UI$PageViews$Documents$Clear = {$: 'Clear'};
...
var $author$project$UI$Sidebar$ClearDropdownOptions = {$: 'ClearDropdownOptions'};
var $author$project$UI$PageViews$Attributes$Purge = {$: 'Purge'};
var $author$project$UI$PageViews$StopWords$Purge = {$: 'Purge'};
var $author$project$UI$PageViews$Synonyms$Purge = {$: 'Purge'};
var $author$project$UI$PageViews$Documents$update = F2(
	function (msg, model) {
		if (msg.$ === 'Clear') {
			return _Utils_update(
				model,
		...
		switch (msg.$) {
			...
			case 'Reset':
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'Purge':
				return _Utils_Tuple2($author$project$UI$PageViews$StopWords$init, $elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$UI$PageViews$Synonyms$Delete = function (a) {
	return {$: 'Delete', a: a};
};
...
var $author$project$UI$PageViews$Synonyms$addNew = function (model) {
	return _Utils_Tuple2(
		_Utils_update(
			model,
			{
				synonymCards: _Utils_ap(
					model.synonymCards,
					_List_fromArray(
						[
							$author$project$UI$Components$SynonymCard$init(
							$elm$core$List$length(model.synonymCards))
						]))
			}),
		$elm$core$Platform$Cmd$none);
};
...
var $author$project$Utils$remove = F2(
	function (i, a) {
		var a2 = A3(
		...
		while (true) {
			switch (msg.$) {
				...
				case 'CardViewMsg':
					...
					if (m.$ === 'Remove') {
						var i = m.a;
						var $temp$msg = $author$project$UI$PageViews$Synonyms$Delete(i),
							$temp$model = model;
						msg = $temp$msg;
						model = $temp$model;
						continue update;
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{synonymCards: synonymCards}),
							$elm$core$Platform$Cmd$none);
					}
				case 'Delete':
					var index = msg.a;
					var dq = model.deletionQueue;
					var arr = $elm$core$Array$fromList(model.synonymCards);
					var uarr = A2($author$project$Utils$remove, index, arr);
					var udq = function () {
						var _v3 = A2($elm$core$Array$get, index, arr);
						if (_v3.$ === 'Just') {
							var e = _v3.a;
							return _Utils_ap(
								dq,
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								deletionQueue: udq,
								synonymCards: $elm$core$Array$toList(uarr)
							}),
						$elm$core$Platform$Cmd$none);
				case 'Purge':
					return _Utils_Tuple2($author$project$UI$PageViews$Synonyms$init, $elm$core$Platform$Cmd$none);
				default:
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			}
		}
...
var $author$project$Main$purgeModel = function (model) {
	var settings = model.pages.settings;
	var selectedPage = model.pages.selectedPage;
	var documents = A2($author$project$UI$PageViews$Documents$update, $author$project$UI$PageViews$Documents$Clear, model.pages.documents);
	var attributes = A2($author$project$UI$PageViews$Attributes$update, $author$project$UI$PageViews$Attributes$Purge, model.pages.attributes);
	var _v0 = A2($author$project$UI$PageViews$Synonyms$update, $author$project$UI$PageViews$Synonyms$Purge, model.pages.synonyms);
	var synonyms = _v0.a;
	var _v1 = A2($author$project$UI$PageViews$StopWords$update, $author$project$UI$PageViews$StopWords$Purge, model.pages.stopWords);
	var stopWords = _v1.a;
	var _v2 = A2($author$project$UI$Sidebar$update, $author$project$UI$Sidebar$ClearDropdownOptions, model.sidebarModel);
	var s = _v2.a;
	return _Utils_update(
		model,
		{
			pages: {attributes: attributes, documents: documents, selectedPage: selectedPage, settings: settings, stopWords: stopWords, synonyms: synonyms},
			sidebarModel: s
		});
};
	...
	function (model, sidebarMsg) {
		...
		while (true) {
			switch (sidebarMsg.$) {
					...
					switch (p.$) {
						...
						case 'Documents':
							...
							if (_v2.$ === 'Just') {
								...
								var updatedDocsPage = A2($author$project$UI$PageViews$Documents$update, $author$project$UI$PageViews$Documents$Clear, model.pages.documents);
								var up = A2($author$project$Main$updateDocumentsViewModel, model.pages, updatedDocsPage);
								return _Utils_Tuple2(
									_Utils_update(
										updatedModel,
										{pages: up}),
				...
				default:
					return _Utils_Tuple2(
						$author$project$Main$purgeModel(model),
						$elm$core$Platform$Cmd$none);
			}
		}
	});
		...
		switch (apiResponse.$) {
			case 'HandleListIndexesResponse':
				...
				if (r.$ === 'Ok') {
					...
					var selectedPage = model.pages.selectedPage;
					var purgedModel = $author$project$Main$purgeModel(model);
					return A2(
						$author$project$Main$handleSidebarSelection,
						purgedModel,
						$author$project$UI$Sidebar$SelectPage(selectedPage));
			...
			case 'HandleListSynonymsResponse':
				...
				if (r.$ === 'Ok') {
					...
					var updatedSynonymsViewModel = {deletionQueue: model.pages.synonyms.deletionQueue, synonymCards: synonyms};
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
			...
			case 'HandleListDisplayedAttrsResponse':
				...
				if (r.$ === 'Ok') {
					var payload = r.a;
					var updatedAttrViewModel = A2(
						$author$project$UI$PageViews$Attributes$update,
						A2($author$project$UI$PageViews$Attributes$HandleResponse, $author$project$UI$PageViews$Attributes$Displayed, payload),
						model.pages.attributes);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								pages: A2($author$project$Main$updateAttributesViewModel, model.pages, updatedAttrViewModel)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			...
			case 'HandleListSortableAttrsResponse':
				...
				if (r.$ === 'Ok') {
					...
					var updatedAttrViewModel = A2(
						$author$project$UI$PageViews$Attributes$update,
						A2($author$project$UI$PageViews$Attributes$HandleResponse, $author$project$UI$PageViews$Attributes$Sortable, payload),
						model.pages.attributes);
					return _Utils_Tuple2(
						_Utils_update(
							model,
			...
			case 'HandleListFilterableAttrsResponse':
				...
				if (r.$ === 'Ok') {
					...
					var updatedAttrViewModel = A2(
						$author$project$UI$PageViews$Attributes$update,
						A2($author$project$UI$PageViews$Attributes$HandleResponse, $author$project$UI$PageViews$Attributes$Filterable, payload),
						model.pages.attributes);
					return _Utils_Tuple2(
						_Utils_update(
							model,
			...
			case 'HandleListSearchableAttrsResponse':
				...
				if (r.$ === 'Ok') {
					...
					var updatedAttrViewModel = A2(
						$author$project$UI$PageViews$Attributes$update,
						A2($author$project$UI$PageViews$Attributes$HandleResponse, $author$project$UI$PageViews$Attributes$Searchable, payload),
						model.pages.attributes);
					return _Utils_Tuple2(
						_Utils_update(
							model,
				...
				if (r.$ === 'Ok') {
					...
					if (payload.$ === 'Just') {
						...
						var updatedAttrViewModel = A2(
							$author$project$UI$PageViews$Attributes$update,
							A2(
								$author$project$UI$PageViews$Attributes$HandleResponse,
			...
			default:
				...
				if (r.$ === 'Ok') {
					...
					var updatedAttributesPageViewModel = $author$project$UI$PageViews$Attributes$seedModelFromAttributeKeys(keys);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
		...
		switch (msg.$) {
											...
											A3(
												...
												A2(
													...
													A2(
														...
														model.pages.attributes.displayed)),
											...
											A3(
												...
												A2(
													...
													A2(
														...
														model.pages.attributes.filterable)),
												$author$project$Api$Routes$Main$settingsUpdateDecoder),
											rootUrl),
										$author$project$Main$getSavedToken(model))),
									A2(
											...
											A3(
												...
												A2(
													...
													A2(
														...
														model.pages.attributes.searchable)),
												$author$project$Api$Routes$Main$settingsUpdateDecoder),
											rootUrl),
										$author$project$Main$getSavedToken(model))),
									A2(
											...
											A3(
												...
												A2(
													...
													A2(
														...
														model.pages.attributes.sortable)),
												$author$project$Api$Routes$Main$settingsUpdateDecoder),
											rootUrl),
										$author$project$Main$getSavedToken(model))),
									function () {
									var _v14 = $author$project$UI$PageViews$Attributes$getDistinctAttr(model.pages.attributes.distinct);
									if (_v14.$ === 'Just') {
										var da = _v14.a;
										return A2(
											$elm$core$Platform$Cmd$map,
			...
			case 'Reset':
				return A2(
					...
					model);
			default:
				var updatedAttrsViewModel = A2($author$project$UI$PageViews$Attributes$update, msg, model.pages.attributes);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							pages: A2($author$project$Main$updateAttributesViewModel, model.pages, updatedAttrsViewModel)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var p = msg.a;
				var updatedAttributes = $author$project$UI$PageViews$Attributes$seedModelFromAttributeKeys(p.keys);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
			...
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$fillRule('evenodd'),
						$elm$svg$Svg$Attributes$clipRule('evenodd'),
						$elm$svg$Svg$Attributes$d('M8.78035 1.71971C8.9983 1.93768 9.0607 2.2668 8.93765 2.54942C8.45313 3.66226 8.25 5.00443 8.25 6.37502C8.25 11.5525 12.4475 15.75 17.625 15.75C18.9956 15.75 20.3378 15.5469 21.4506 15.0624C21.7332 14.9393 22.0623 15.0017 22.2803 15.2197C22.4983 15.4376 22.5607 15.7667 22.4377 16.0494C20.7558 19.913 16.8223 22.5 12.375 22.5C6.36907 22.5 1.5 17.631 1.5 11.625C1.5 7.17771 4.08704 3.24418 7.95066 1.56235C8.23328 1.43932 8.5624 1.50174 8.78035 1.71971ZM6.9893 3.81353C4.55977 5.51825 3 8.40413 3 11.625C3 16.8025 7.19749 21 12.375 21C15.5959 21 18.4818 19.4403 20.1865 17.0107C19.3445 17.1795 18.4746 17.25 17.625 17.25C11.6191 17.25 6.75 12.381 6.75 6.37502C6.75 5.52539 6.82048 4.6555 6.9893 3.81353Z')
					]),
				_List_Nil)
			]);
	}
		...
		[
			...
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$fillRule('evenodd'),
					$elm$svg$Svg$Attributes$clipRule('evenodd'),
					$elm$svg$Svg$Attributes$d('M0.75 3.75C0.75 2.92157 1.42157 2.25 2.25 2.25H21.75C22.5784 2.25 23.25 2.92157 23.25 3.75V6C23.25 6.82843 22.5784 7.5 21.75 7.5H20.9261L19.6521 19.7529C19.6517 19.7562 19.6513 19.7596 19.651 19.763C19.5865 20.3104 19.3234 20.8151 18.9115 21.1814C18.4996 21.5476 17.9676 21.75 17.4164 21.75H6.58405C6.03285 21.75 5.50084 21.5476 5.08895 21.1814C4.67705 20.8151 4.41394 20.3104 4.34952 19.763C4.34912 19.7596 4.34875 19.7563 4.3484 19.7529L3.07396 7.5H2.25C1.42157 7.5 0.75 6.82843 0.75 6V3.75ZM3.76038 6C3.75408 5.99992 3.74777 5.99992 3.74144 6H2.25V3.75H21.75V6H20.2586C20.2522 5.99992 20.2459 5.99992 20.2396 6H3.76038ZM4.58205 7.5L5.83974 19.5918C5.86205 19.7727 5.94946 19.9393 6.08571 20.0605C6.22301 20.1826 6.40035 20.25 6.58408 20.25H17.4164C17.6001 20.25 17.7775 20.1826 17.9148 20.0605C18.051 19.9393 18.1384 19.7727 18.1607 19.5918L19.418 7.5H4.58205ZM8.84467 10.7197C9.13756 10.4268 9.61244 10.4268 9.90533 10.7197L12 12.8143L14.0947 10.7197C14.3876 10.4268 14.8624 10.4268 15.1553 10.7197C15.4482 11.0126 15.4482 11.4874 15.1553 11.7803L13.0607 13.875L15.1553 15.9697C15.4482 16.2626 15.4482 16.7374 15.1553 17.0303C14.8624 17.3232 14.3876 17.3232 14.0947 17.0303L12 14.9357L9.90533 17.0303C9.61244 17.3232 9.13756 17.3232 8.84467 17.0303C8.55178 16.7374 8.55178 16.2626 8.84467 15.9697L10.9393 13.875L8.84467 11.7803C8.55178 11.4874 8.55178 11.0126 8.84467 10.7197Z')
				]),
			_List_Nil)
		]);
};
	...
	if (style.$ === 'Outline') {
			...
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$fillRule('evenodd'),
						$elm$svg$Svg$Attributes$clipRule('evenodd'),
						$elm$svg$Svg$Attributes$d('M12 1.5C12.4142 1.5 12.75 1.83579 12.75 2.25V4.5C12.75 4.91421 12.4142 5.25 12 5.25C11.5858 5.25 11.25 4.91421 11.25 4.5V2.25C11.25 1.83579 11.5858 1.5 12 1.5Z')
					]),
				_List_Nil),
				A2(
				$elm$svg$Svg$path,
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$fillRule('evenodd'),
						$elm$svg$Svg$Attributes$clipRule('evenodd'),
						$elm$svg$Svg$Attributes$d('M12 18.75C12.4142 18.75 12.75 19.0858 12.75 19.5V21.75C12.75 22.1642 12.4142 22.5 12 22.5C11.5858 22.5 11.25 22.1642 11.25 21.75V19.5C11.25 19.0858 11.5858 18.75 12 18.75Z')
					]),
				_List_Nil),
				A2(
				$elm$svg$Svg$path,
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$fillRule('evenodd'),
						$elm$svg$Svg$Attributes$clipRule('evenodd'),
						$elm$svg$Svg$Attributes$d('M19.4247 4.57529C19.7176 4.86819 19.7176 5.34306 19.4247 5.63595L17.8338 7.22689C17.5409 7.51979 17.066 7.51979 16.7731 7.22689C16.4802 6.934 16.4802 6.45913 16.7731 6.16623L18.364 4.57529C18.6569 4.2824 19.1318 4.2824 19.4247 4.57529Z')
					]),
				_List_Nil),
				A2(
				$elm$svg$Svg$path,
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$fillRule('evenodd'),
						$elm$svg$Svg$Attributes$clipRule('evenodd'),
						$elm$svg$Svg$Attributes$d('M7.22689 16.7731C7.51979 17.066 7.51979 17.5409 7.22689 17.8338L5.63595 19.4247C5.34306 19.7176 4.86819 19.7176 4.57529 19.4247C4.2824 19.1318 4.2824 18.6569 4.57529 18.364L6.16623 16.7731C6.45913 16.4802 6.934 16.4802 7.22689 16.7731Z')
					]),
				_List_Nil),
				A2(
				$elm$svg$Svg$path,
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$fillRule('evenodd'),
						$elm$svg$Svg$Attributes$clipRule('evenodd'),
						$elm$svg$Svg$Attributes$d('M18.75 12C18.75 11.5858 19.0858 11.25 19.5 11.25H21.75C22.1642 11.25 22.5 11.5858 22.5 12C22.5 12.4142 22.1642 12.75 21.75 12.75H19.5C19.0858 12.75 18.75 12.4142 18.75 12Z')
					]),
				_List_Nil),
				A2(
				$elm$svg$Svg$path,
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$fillRule('evenodd'),
						$elm$svg$Svg$Attributes$clipRule('evenodd'),
						$elm$svg$Svg$Attributes$d('M1.5 12C1.5 11.5858 1.83579 11.25 2.25 11.25H4.5C4.91421 11.25 5.25 11.5858 5.25 12C5.25 12.4142 4.91421 12.75 4.5 12.75H2.25C1.83579 12.75 1.5 12.4142 1.5 12Z')
					]),
				_List_Nil),
				A2(
				$elm$svg$Svg$path,
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$fillRule('evenodd'),
						$elm$svg$Svg$Attributes$clipRule('evenodd'),
						$elm$svg$Svg$Attributes$d('M16.7731 16.7731C17.066 16.4802 17.5409 16.4802 17.8338 16.7731L19.4247 18.364C19.7176 18.6569 19.7176 19.1318 19.4247 19.4247C19.1318 19.7176 18.6569 19.7176 18.364 19.4247L16.7731 17.8338C16.4802 17.5409 16.4802 17.066 16.7731 16.7731Z')
					]),
				_List_Nil),
				A2(
				$elm$svg$Svg$path,
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$fillRule('evenodd'),
						$elm$svg$Svg$Attributes$clipRule('evenodd'),
						$elm$svg$Svg$Attributes$d('M4.57529 4.57529C4.86819 4.2824 5.34306 4.2824 5.63595 4.57529L7.22689 6.16623C7.51979 6.45913 7.51979 6.934 7.22689 7.22689C6.934 7.51979 6.45913 7.51979 6.16623 7.22689L4.57529 5.63595C4.2824 5.34306 4.2824 4.86819 4.57529 4.57529Z')
					]),
				_List_Nil),
				A2(
				$elm$svg$Svg$path,
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$fillRule('evenodd'),
						$elm$svg$Svg$Attributes$clipRule('evenodd'),
						$elm$svg$Svg$Attributes$d('M12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9ZM7.5 12C7.5 9.51472 9.51472 7.5 12 7.5C14.4853 7.5 16.5 9.51472 16.5 12C16.5 14.4853 14.4853 16.5 12 16.5C9.51472 16.5 7.5 14.4853 7.5 12Z')
					]),
				_List_Nil)
			]);
	} else {
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M12 5.53125C11.7265 5.53125 11.4642 5.4226 11.2708 5.2292C11.0774 5.03581 10.9688 4.7735 10.9688 4.5V2.25C10.9688 1.9765 11.0774 1.71419 11.2708 1.5208C11.4642 1.3274 11.7265 1.21875 12 1.21875C12.2735 1.21875 12.5358 1.3274 12.7292 1.5208C12.9226 1.71419 13.0312 1.9765 13.0312 2.25V4.5C13.0312 4.7735 12.9226 5.03581 12.7292 5.2292C12.5358 5.4226 12.2735 5.53125 12 5.53125Z')
					]),
				_List_Nil),
				A2(
				$elm$svg$Svg$path,
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M12 22.7812C11.7265 22.7812 11.4642 22.6726 11.2708 22.4792C11.0774 22.2858 10.9688 22.0235 10.9688 21.75V19.5C10.9688 19.2265 11.0774 18.9642 11.2708 18.7708C11.4642 18.5774 11.7265 18.4688 12 18.4688C12.2735 18.4688 12.5358 18.5774 12.7292 18.7708C12.9226 18.9642 13.0312 19.2265 13.0312 19.5V21.75C13.0312 22.0235 12.9226 22.2858 12.7292 22.4792C12.5358 22.6726 12.2735 22.7812 12 22.7812Z')
					]),
				_List_Nil),
				A2(
				$elm$svg$Svg$path,
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M17.3034 7.72781C17.0995 7.72779 16.9002 7.66731 16.7306 7.55402C16.5611 7.44073 16.4289 7.27972 16.3509 7.09134C16.2728 6.90296 16.2523 6.69566 16.2921 6.49565C16.3318 6.29565 16.4299 6.11191 16.5741 5.96766L18.165 4.37672C18.3592 4.18753 18.6202 4.08245 18.8913 4.08424C19.1625 4.08602 19.422 4.19453 19.6137 4.38626C19.8055 4.57799 19.914 4.83753 19.9158 5.10867C19.9176 5.37982 19.8125 5.64076 19.6233 5.835L18.0323 7.42594C17.9367 7.52178 17.8231 7.59778 17.698 7.64959C17.5729 7.70139 17.4388 7.72797 17.3034 7.72781Z')
					]),
				_List_Nil),
				A2(
				$elm$svg$Svg$path,
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M5.10562 19.9256C4.90165 19.9256 4.70227 19.8651 4.53269 19.7517C4.36311 19.6384 4.23095 19.4773 4.15293 19.2888C4.07491 19.1004 4.05452 18.893 4.09436 18.693C4.13419 18.4929 4.23246 18.3092 4.37672 18.165L5.96766 16.5741C6.06294 16.4762 6.17672 16.3983 6.30237 16.3448C6.42802 16.2913 6.56304 16.2633 6.69961 16.2624C6.83617 16.2615 6.97156 16.2877 7.0979 16.3396C7.22425 16.3914 7.33904 16.4678 7.4356 16.5644C7.53217 16.661 7.6086 16.7758 7.66045 16.9021C7.71229 17.0284 7.73853 17.1638 7.73763 17.3004C7.73673 17.437 7.70871 17.572 7.65521 17.6976C7.6017 17.8233 7.52377 17.9371 7.42594 18.0323L5.835 19.6233C5.73934 19.7192 5.62565 19.7954 5.50048 19.8472C5.37531 19.8991 5.24112 19.9258 5.10562 19.9256Z')
					]),
				_List_Nil),
				A2(
				$elm$svg$Svg$path,
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M18.8944 19.9256C18.7589 19.9258 18.6247 19.8991 18.4995 19.8472C18.3743 19.7954 18.2607 19.7192 18.165 19.6233L16.5741 18.0323C16.3849 17.8381 16.2798 17.5772 16.2816 17.306C16.2834 17.0349 16.3919 16.7753 16.5836 16.5836C16.7753 16.3919 17.0349 16.2834 17.306 16.2816C17.5772 16.2798 17.8381 16.3849 18.0323 16.5741L19.6233 18.165C19.7675 18.3092 19.8658 18.4929 19.9056 18.693C19.9455 18.893 19.9251 19.1004 19.8471 19.2888C19.769 19.4773 19.6369 19.6384 19.4673 19.7517C19.2977 19.8651 19.0983 19.9256 18.8944 19.9256Z')
					]),
				_List_Nil),
				A2(
				$elm$svg$Svg$path,
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M12 16.7812C11.0544 16.7812 10.13 16.5008 9.34368 15.9755C8.55741 15.4501 7.94458 14.7034 7.5827 13.8297C7.22082 12.956 7.12613 11.9947 7.31062 11.0672C7.49511 10.1398 7.95048 9.28782 8.61915 8.61915C9.28782 7.95048 10.1398 7.49511 11.0672 7.31062C11.9947 7.12613 12.956 7.22082 13.8297 7.5827C14.7034 7.94458 15.4501 8.55741 15.9755 9.34368C16.5008 10.13 16.7812 11.0544 16.7812 12C16.7798 13.2676 16.2755 14.4829 15.3792 15.3792C14.4829 16.2755 13.2676 16.7798 12 16.7812Z')
					]),
				_List_Nil)
			]);
	}
...
var $author$project$UI$Icons$systemThemeMode = function (style) {
	if (style.$ === 'Outline') {
		return _List_fromArray(
			[
				A2(
...
var $author$project$UI$Elements$getButtonProps = F2(
	function (buttonType, config) {
		switch (buttonType.$) {
			case 'Subtle':
				return {
					bgColor: A3($author$project$UI$Styles$color, $author$project$UI$Styles$Grayscale, $author$project$UI$Styles$I100, config),
	...
	function (model, create, sync, cancel, config) {
		return A2(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
					A2($mdgriffith$elm_ui$Element$paddingXY, 120, 20),
...
var $author$project$UI$PageViews$Documents$None = {$: 'None'};
var $author$project$UI$PageViews$Documents$toolbarView = F2(
	function (_v0, config) {
		...
		return A5($author$project$UI$Components$Toolbar$toolbarView, toolbarModel, $author$project$UI$PageViews$Documents$None, $author$project$UI$PageViews$Documents$None, $author$project$UI$PageViews$Documents$None, config);
	});
...
var $author$project$UI$Icons$DarkMode = {$: 'DarkMode'};
...
var $author$project$UI$Elements$tile = F5(
	function (icon, title, selected, clicked, config) {
		var iconFillStyle = selected ? $author$project$UI$Icons$Filled : $author$project$UI$Icons$Outline;
		var hue = selected ? $author$project$UI$Styles$Primary : $author$project$UI$Styles$Grayscale;
		var bgColor = selected ? A3($author$project$UI$Styles$color, $author$project$UI$Styles$Primary, $author$project$UI$Styles$I100, config) : A3($author$project$UI$Styles$color, $author$project$UI$Styles$White, $author$project$UI$Styles$Generic, config);
		return A2(
			$mdgriffith$elm_ui$Element$el,
			A2($author$project$UI$Styles$getTypographicStyleFor, $author$project$UI$Styles$Body, config),
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Background$color(
								A3($author$project$UI$Styles$color, hue, $author$project$UI$Styles$I200, config))
							])),
						$mdgriffith$elm_ui$Element$Border$color(
						A3($author$project$UI$Styles$color, hue, $author$project$UI$Styles$I200, config)),
						...
						$mdgriffith$elm_ui$Element$height(
						$mdgriffith$elm_ui$Element$px(80)),
						$mdgriffith$elm_ui$Element$Events$onClick(clicked),
						$mdgriffith$elm_ui$Element$pointer
					]),
				_List_fromArray(
					[
						...
						A5($author$project$UI$Icons$buildIcon, icon, iconFillStyle, config, hue, $author$project$UI$Styles$I500)),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$Font$color(
								A3($author$project$UI$Styles$color, hue, $author$project$UI$Styles$I500, config))
							]),
						$mdgriffith$elm_ui$Element$text(title))
					])));
	});
						...
						[
							...
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$el,
									A2($author$project$UI$Styles$getTypographicStyleFor, $author$project$UI$Styles$Label, config),
									$mdgriffith$elm_ui$Element$text('Theme')),
									$author$project$UI$Elements$spacer($author$project$UI$Styles$SM),
									A2(
									$mdgriffith$elm_ui$Element$row,
									_List_Nil,
									_List_fromArray(
										[
											...
											$author$project$UI$Icons$LightMode,
											'Light',
											_Utils_eq(model.colorScheme, $author$project$UI$Styles$Light),
											$author$project$UI$PageViews$Settings$UpdateColorScheme($author$project$UI$Styles$Light),
											config),
											$author$project$UI$Elements$spacer($author$project$UI$Styles$SM),
											A5(
											$author$project$UI$Elements$tile,
											$author$project$UI$Icons$DarkMode,
											'Dark',
	...
	return (!(!$elm$core$List$length(
		A2(
			...
			A2(
				...
				model.synonymCards))))) || ($elm$core$List$length(model.deletionQueue) > 0);
};
...
var $author$project$UI$Components$SynonymCard$Reset = function (a) {
	return {$: 'Reset', a: a};
};
var $author$project$UI$Components$SynonymCard$valueChangedView = F2(
	function (model, config) {
		return ($author$project$UI$Components$SynonymCard$valueChanged(model) && (!_Utils_eq(model.requestStatus, $author$project$Request$Fired))) ? A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
...
var $author$project$UI$Components$SynonymCard$cardToolbar = F2(
	function (model, config) {
		return A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
			...
			_List_fromArray(
				[
					(!_Utils_eq(model.requestStatus, $author$project$Request$Fired)) ? A3(
					$author$project$UI$Elements$iconButton,
					$author$project$UI$Icons$Trash,
					$author$project$UI$Components$SynonymCard$Remove(model.index),
					config) : $mdgriffith$elm_ui$Element$none,
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_Nil,
					_List_fromArray(
						[
							...
							A2($author$project$UI$Components$SynonymCard$valueChangedView, model, config)
						]))
				]));
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					config),
					$author$project$UI$Elements$spacer($author$project$UI$Styles$SM),
					A2($author$project$UI$Components$SynonymCard$cardToolbar, model, config)
				]));
	});
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Api.Routes.Main.IndexKeys":{"args":[],"type":"{ indexUid : String.String, keys : List.List String.String }"},"Api.Routes.Main.IndexStats":{"args":[],"type":"{ numberOfDocuments : Basics.Int, isIndexing : Basics.Bool, fieldDistribution : Dict.Dict String.String Basics.Int }"},"Api.Routes.Main.IndexesRouteResponseListItem":{"args":[],"type":"{ uid : String.String, name : String.String, createdAt : String.String, updatedAt : String.String, primaryKey : String.String }"},"Api.Routes.Main.SettingsRouteResponseItem":{"args":[],"type":"{ uid : Basics.Int, indexUid : String.String }"},"UI.PageViews.Attributes.Attribute":{"args":[],"type":"{ title : String.String, enabled : Basics.Bool, saved : Basics.Bool, requestStatus : Request.RequestStatus }"},"UI.Components.Dropdown.Item":{"args":[],"type":"{ title : String.String, id : String.String }"},"UI.Components.SynonymCard.Model":{"args":[],"type":"{ index : Basics.Int, synonymKey : String.String, synonymsValue : String.String, synonymList : List.List String.String, saved : Maybe.Maybe ( String.String, List.List String.String ), requestStatus : Request.RequestStatus, taskId : Maybe.Maybe Basics.Int }"},"UI.PageViews.Attributes.Model":{"args":[],"type":"{ displayed : List.List UI.PageViews.Attributes.Attribute, sortable : List.List UI.PageViews.Attributes.Attribute, searchable : List.List UI.PageViews.Attributes.Attribute, filterable : List.List UI.PageViews.Attributes.Attribute, distinct : List.List UI.PageViews.Attributes.Attribute }"},"UI.PageViews.Documents.Model":{"args":[],"type":"{ documents : List.List String.String }"},"UI.PageViews.Settings.Model":{"args":[],"type":"{ tokenValue : String.String, colorScheme : UI.Styles.ColorScheme, savedTokenValue : String.String, endpointValue : String.String, savedEndpointValue : String.String }"},"UI.PageViews.StopWords.Model":{"args":[],"type":"{ words : List.List UI.PageViews.StopWords.StopWord, newValue : String.String, deletionQueue : List.List UI.PageViews.StopWords.StopWord }"},"UI.PageViews.Synonyms.Model":{"args":[],"type":"{ synonymCards : List.List UI.Components.SynonymCard.Model, deletionQueue : List.List UI.Components.SynonymCard.Model }"},"UI.PageViews.StopWords.StopWord":{"args":[],"type":"{ title : String.String, requestStatus : Request.RequestStatus, saved : Basics.Bool }"}},"unions":{"Main.Msg":{"args":[],"tags":{"SidebarMsg":["UI.Sidebar.Msg"],"PageViewMsg":["UI.PageView.Msg"],"ApiRequest":["Api.Routes.Main.Msg"],"PollUpdate":["Main.Task","SweetPoll.Msg String.String"],"AddToPollQueue":["Main.Task"],"UpdateKeysForIndex":["Api.Routes.Main.IndexKeys"]}},"List.List":{"args":["a"],"tags":{}},"Api.Routes.Main.Msg":{"args":[],"tags":{"HandleListIndexesResponse":["Result.Result Http.Error (List.List Api.Routes.Main.IndexesRouteResponseListItem)"],"HandleDocumentsResponse":["Result.Result Http.Error String.String"],"HandleListStopWordsResponse":["Result.Result Http.Error (List.List String.String)","String.String"],"HandleUpdateSynonymsResponse":["Result.Result Http.Error Api.Routes.Main.SettingsRouteResponseItem"],"HandleListSynonymsResponse":["Result.Result Http.Error (Dict.Dict String.String (List.List String.String))","String.String"],"HandleIndexKeysResponse":["Api.Routes.Main.IndexKeys"],"HandleListDisplayedAttrsResponse":["Result.Result Http.Error (List.List String.String)","String.String"],"HandleListSearchableAttrsResponse":["Result.Result Http.Error (List.List String.String)","String.String"],"HandleListSortableAttrsResponse":["Result.Result Http.Error (List.List String.String)","String.String"],"HandleListFilterableAttrsResponse":["Result.Result Http.Error (List.List String.String)","String.String"],"HandleListDistinctAttrResponse":["Result.Result Http.Error (Maybe.Maybe String.String)","String.String"],"HandleUpdateDisplayedAttrsResponse":["Result.Result Http.Error Api.Routes.Main.SettingsRouteResponseItem"],"HandleUpdateFilterableAttrsResponse":["Result.Result Http.Error Api.Routes.Main.SettingsRouteResponseItem"],"HandleUpdateSortableAttrsResponse":["Result.Result Http.Error Api.Routes.Main.SettingsRouteResponseItem"],"HandleUpdateSearchableAttrsResponse":["Result.Result Http.Error Api.Routes.Main.SettingsRouteResponseItem"],"HandleUpdateDistinctAttrResponse":["Result.Result Http.Error Api.Routes.Main.SettingsRouteResponseItem"],"HandleUpdateStopWordsResponse":["Result.Result Http.Error Api.Routes.Main.SettingsRouteResponseItem"],"HandleStatsResponse":["Result.Result Http.Error Api.Routes.Main.IndexStats","String.String"]}},"SweetPoll.Msg":{"args":["data"],"tags":{"PollResult":["Result.Result Http.Error data"]}},"UI.PageView.Msg":{"args":[],"tags":{"SettingsViewMsg":["UI.PageViews.Settings.Msg"],"DocumentsViewMsg":["UI.PageViews.Documents.Msg"],"StopWordsViewMsg":["UI.PageViews.StopWords.Msg"],"SynonymsViewMsg":["UI.PageViews.Synonyms.Msg"],"AttributesViewMsg":["UI.PageViews.Attributes.Msg"]}},"UI.Sidebar.Msg":{"args":[],"tags":{"SelectPage":["UI.Pages.Page"],"DropdownMsg":["UI.Components.Dropdown.Msg"],"ClearDropdownOptions":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Main.Task":{"args":[],"tags":{"UpdateSynonymsTask":["Basics.Int","String.String"],"UpdateAttributeTask":["Basics.Int","String.String","UI.PageViews.Attributes.AttributeType"],"UpdateStopWordsTask":["Basics.Int","String.String"]}},"UI.PageViews.Attributes.AttributeType":{"args":[],"tags":{"Displayed":[],"Sortable":[],"Searchable":[],"Filterable":[],"Distinct":[]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"UI.Components.Dropdown.Msg":{"args":[],"tags":{"TriggerClicked":[],"Select":["UI.Components.Dropdown.Item"]}},"UI.PageViews.Attributes.Msg":{"args":[],"tags":{"Toggle":["UI.PageViews.Attributes.Attribute","UI.PageViews.Attributes.AttributeType"],"Save":[],"Reset":[],"None":[],"UpdateAttributes":["List.List UI.PageViews.Attributes.Attribute","UI.PageViews.Attributes.AttributeType"],"HandleResponse":["UI.PageViews.Attributes.AttributeType","List.List String.String"],"UpdateSyncStatusState":["UI.PageViews.Attributes.AttributeType","Request.RequestStatus"],"Purge":[]}},"UI.PageViews.Documents.Msg":{"args":[],"tags":{"Clear":[],"None":[]}},"UI.PageViews.Settings.Msg":{"args":[],"tags":{"TokenValueChanged":["String.String"],"EndpointValueChanged":["String.String"],"Save":[],"UpdateColorScheme":["UI.Styles.ColorScheme"],"None":[]}},"UI.PageViews.StopWords.Msg":{"args":[],"tags":{"Create":[],"NewValueUpdated":["String.String"],"Remove":["UI.PageViews.StopWords.StopWord"],"Sync":[],"Reset":[],"None":[],"Purge":[]}},"UI.PageViews.Synonyms.Msg":{"args":[],"tags":{"CardViewMsg":["UI.Components.SynonymCard.Msg"],"Sync":[],"New":[],"NoAction":[],"Reset":[],"Delete":["Basics.Int"],"Purge":[]}},"UI.Pages.Page":{"args":[],"tags":{"Settings":["UI.PageViews.Settings.Model"],"Documents":["UI.PageViews.Documents.Model"],"Synonyms":["UI.PageViews.Synonyms.Model"],"StopWords":["UI.PageViews.StopWords.Model"],"Attributes":["UI.PageViews.Attributes.Model"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"UI.Styles.ColorScheme":{"args":[],"tags":{"Light":[],"Dark":[]}},"UI.Components.SynonymCard.Msg":{"args":[],"tags":{"UpdatedTitle":["Basics.Int","String.String"],"UpdatedList":["Basics.Int","String.String"],"Remove":["Basics.Int"],"RetrySave":["Basics.Int"],"Save":["Basics.Int"],"Reset":["Basics.Int"],"DoneEditing":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}},"Request.RequestStatus":{"args":[],"tags":{"NoRequest":[],"Fired":[],"Success":[],"Failed":[]}}}}})}});}(this));