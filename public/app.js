...
var $author$project$UI$Views$Indexes = {$: 'Indexes'};
var $author$project$Main$init = function (_v0) {
	var model = {selectedPage: $author$project$UI$Views$Indexes};
	return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
};
...
var $author$project$UI$Views$Documents = {$: 'Documents'};
var $author$project$UI$Views$Keys = {$: 'Keys'};
var $author$project$UI$Views$Search = {$: 'Search'};
var $author$project$UI$Views$Settings = {$: 'Settings'};
var $author$project$UI$Views$Stats = {$: 'Stats'};
var $author$project$UI$Views$Tasks = {$: 'Tasks'};
		...
		case 'H1':
			return _List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Font$color($author$project$UI$Styles$color.darkCharcoal)
				]);
		case 'H2':
			return _List_fromArray(
				[
...
var $author$project$UI$Views$pageTitle = function (page) {
	switch (page.$) {
		case 'Indexes':
			return 'Indexes';
		case 'Settings':
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$Background$color($author$project$UI$Styles$color.lightGrey)
									]))
							]),
							A2(
							$author$project$UI$Sidebar$addIf,
							isSelected,
							$mdgriffith$elm_ui$Element$Background$color($author$project$UI$Styles$color.lightBlue))
						])),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$text(
									$author$project$UI$Views$pageTitle(page)))
							]))
					])));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$UI$Views$Indexes,
				_Utils_eq(currentPage, $author$project$UI$Views$Indexes)),
				A2(
				$author$project$UI$Sidebar$sidebarListItemView,
				$author$project$UI$Views$Documents,
				_Utils_eq(currentPage, $author$project$UI$Views$Documents)),
				A2(
				$author$project$UI$Sidebar$sidebarListItemView,
				$author$project$UI$Views$Settings,
				_Utils_eq(currentPage, $author$project$UI$Views$Settings)),
				A2(
				$author$project$UI$Sidebar$sidebarListItemView,
				$author$project$UI$Views$Search,
				_Utils_eq(currentPage, $author$project$UI$Views$Search)),
				A2(
				$author$project$UI$Sidebar$sidebarListItemView,
				$author$project$UI$Views$Stats,
				_Utils_eq(currentPage, $author$project$UI$Views$Stats)),
				A2(
				$author$project$UI$Sidebar$sidebarListItemView,
				$author$project$UI$Views$Keys,
				_Utils_eq(currentPage, $author$project$UI$Views$Keys)),
				A2(
				$author$project$UI$Sidebar$sidebarListItemView,
				$author$project$UI$Views$Tasks,
				_Utils_eq(currentPage, $author$project$UI$Views$Tasks))
			]));
};
...
var $author$project$UI$Pages$Documents$view = A2(
	...
	$mdgriffith$elm_ui$Element$text(
		$author$project$UI$Views$pageTitle($author$project$UI$Views$Documents)));
var $author$project$UI$Pages$Indexes$view = A2(
	$mdgriffith$elm_ui$Element$el,
	$author$project$UI$Styles$getTypographicStyleFor($author$project$UI$Styles$H1),
	$mdgriffith$elm_ui$Element$text(
		$author$project$UI$Views$pageTitle($author$project$UI$Views$Indexes)));
var $author$project$UI$Pages$Keys$view = A2(
	$mdgriffith$elm_ui$Element$el,
	$author$project$UI$Styles$getTypographicStyleFor($author$project$UI$Styles$H1),
	$mdgriffith$elm_ui$Element$text(
		$author$project$UI$Views$pageTitle($author$project$UI$Views$Keys)));
var $author$project$UI$Pages$Search$view = A2(
	$mdgriffith$elm_ui$Element$el,
	$author$project$UI$Styles$getTypographicStyleFor($author$project$UI$Styles$H1),
	$mdgriffith$elm_ui$Element$text(
		$author$project$UI$Views$pageTitle($author$project$UI$Views$Search)));
var $author$project$UI$Pages$Settings$view = A2(
	$mdgriffith$elm_ui$Element$el,
	$author$project$UI$Styles$getTypographicStyleFor($author$project$UI$Styles$H1),
	$mdgriffith$elm_ui$Element$text(
		$author$project$UI$Views$pageTitle($author$project$UI$Views$Settings)));
var $author$project$UI$Pages$Stats$view = A2(
	$mdgriffith$elm_ui$Element$el,
	$author$project$UI$Styles$getTypographicStyleFor($author$project$UI$Styles$H1),
	$mdgriffith$elm_ui$Element$text(
		$author$project$UI$Views$pageTitle($author$project$UI$Views$Stats)));
var $author$project$UI$Pages$Tasks$view = A2(
	$mdgriffith$elm_ui$Element$el,
	$author$project$UI$Styles$getTypographicStyleFor($author$project$UI$Styles$H1),
	$mdgriffith$elm_ui$Element$text(
		$author$project$UI$Views$pageTitle($author$project$UI$Views$Tasks)));
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"SidebarMsg":["UI.Sidebar.Msg"],"PageViewMsg":["UI.PageView.Msg"]}},"UI.PageView.Msg":{"args":[],"tags":{"IndexesViewMsg":["UI.Pages.Indexes.Msg"],"SettingsViewMsg":["UI.Pages.Settings.Msg"],"SearchViewMsg":["UI.Pages.Search.Msg"],"StatsViewMsg":["UI.Pages.Stats.Msg"],"DocumentsViewMsg":["UI.Pages.Documents.Msg"],"KeysViewMsg":["UI.Pages.Keys.Msg"],"TasksViewMsg":["UI.Pages.Tasks.Msg"]}},"UI.Sidebar.Msg":{"args":[],"tags":{"SelectPage":["UI.Views.Page"]}},"UI.Pages.Documents.Msg":{"args":[],"tags":{"X":[]}},"UI.Pages.Indexes.Msg":{"args":[],"tags":{"X":[]}},"UI.Pages.Keys.Msg":{"args":[],"tags":{"X":[]}},"UI.Pages.Search.Msg":{"args":[],"tags":{"X":[]}},"UI.Pages.Settings.Msg":{"args":[],"tags":{"X":[]}},"UI.Pages.Stats.Msg":{"args":[],"tags":{"X":[]}},"UI.Pages.Tasks.Msg":{"args":[],"tags":{"X":[]}},"UI.Views.Page":{"args":[],"tags":{"Indexes":[],"Settings":[],"Search":[],"Stats":[],"Documents":[],"Keys":[],"Tasks":[]}}}}})}});}(this));