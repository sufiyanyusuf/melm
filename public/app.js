...
var $author$project$Main$buildSynonymsViewModel = function (d) {
	return A2(
	...
	function (model, apiResponse) {
		switch (apiResponse.$) {
			...
			default:
				...
				if (r.$ === 'Ok') {
					var payload = r.a;
					var synonyms = $author$project$Main$buildSynonymsViewModel(payload);
